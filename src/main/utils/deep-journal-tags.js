...
class DeepJournalTags {
  ...
  load(deepJournalPath) {
    ...
    const tagsFilePath = path.join(this.deepJournalPath, this.fileName);
  ...
  save() {
    ...
    const tagsPath = path.join(this.deepJournalPath, this.fileName);
...
module.exports = new DeepJournalTags();
