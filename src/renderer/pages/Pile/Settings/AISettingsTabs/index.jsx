      ...
      <Tabs.List className={styles.tabsList} aria-label="Manage your account">
        <Tabs.Trigger
          className={`${styles.tabsTrigger} ${
            pileAIProvider === 'gemini' ? styles.activeLeft : ''
          } ${pileAIProvider === 'ollama' ? styles.activeCenter : ''} ${pileAIProvider === 'openai' ? styles.activeRight : ''}`}
          value="subscription"
        >
          Subscription
        ...
        <Tabs.Trigger
          ...
          } ${pileAIProvider === 'gemini' ? styles.activeCenter : ''} ${pileAIProvider === 'openai' ? styles.activeRight : ''}`}
          value="gemini"
        >
          Gemini API
      ...
      <Tabs.Content className={styles.tabsContent} value="gemini">
        <div className={styles.providers}>
          <div className={styles.pitch}>
            ...
            using Gemini 1.5 Pro models in Pile.
          </div>
